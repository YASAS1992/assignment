...
/* harmony import */ var _framework_delegate_244a6159_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-244a6159.js */ 3322);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
...
let Popover = class {
  constructor(hostRef) {
    ...
    this.coreDelegate = (0,_framework_delegate_244a6159_js__WEBPACK_IMPORTED_MODULE_3__.C)();
    this.inline = false;
  ...
  present(event) {
    ...
    return (0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_244a6159_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, _this2.el, _this2.component, ['popover-viewport'], data, inline);
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (shouldDismiss) {
        ...
        yield (0,_framework_delegate_244a6159_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this3.usersElement);
      }
