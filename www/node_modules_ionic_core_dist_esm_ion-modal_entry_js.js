...
let Modal = class {
  ...
  present() {
    ...
    return (0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.usersElement = yield (0,_framework_delegate_244a6159_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, _this.el, _this.component, ['ion-page'], data, inline);
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_yasasweerasekara_my_first_app_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_244a6159_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this4.usersElement);
